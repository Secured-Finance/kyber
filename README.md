...
the import path is: `github.com/Secured-Finance/kyber`.
...
import (
    "fmt"
    "github.com/Secured-Finance/kyber/suites"
)
...
3. Type “go build”. The go tool will fill in the new dependencies that it find for you, i.e. "require github.com/Secured-Finance/kyber v3.0.13”.
